(function() {
  var AnnouncementItem, Announcements,
  ...
  Announcements = (function() {
    ...
    Announcements.prototype.fillAnnouncements = function() {
      ...
      $("<tr><th>Start Date: </th><td><input id='startdate' name='startdate' class='form-control input-sm' type='text'></td>").appendTo(this.table);
      $("<tr><th>End Date: </th><td><input id='enddate' name='enddate' class='form-control input-sm' type='text'></td>").appendTo(this.table);
    ...
    Announcements.prototype.onSave = function(andThen) {
      var convertEnd, convertStart, desc, end, item, parseEnd, parseStart, postURL, repeat_frequency, start, title;
      title = $("#title").val();
        ...
        error: (function(_this) {
          return function(jqXHR, textStatus, errorThrown) {
            ...
            if (msg.indexOf("Duplicate") > -1) {
              return alert("Your title has already existed");
            }
          };
        })(this)
      });
    ...
    Announcements.prototype.validate = function() {
  ...
  AnnouncementItem = (function() {
    function AnnouncementItem(title, description, start_date, end_date, recur, repeat_frequency) {
      this.title = title;
